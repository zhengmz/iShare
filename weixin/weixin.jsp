...
class WeiXinHandler {
	...
	public void responseMsg() {
		...
		if (null!=postStr && !postStr.isEmpty()){
			...
			if(null!=keyword && !keyword.equals(""))
            {
            	...
            	String contentStr = retureMsg(keyword);
	...
	public String retureMsg(String keyword) {
		String resultString = "";
		String fileName = "";
		...
		//this.print(readtxt("/usr/share/tomcat6/webapps/ROOT/1.txt"));
		resultString = resultString + readtxt("/usr/share/tomcat6/webapps/ROOT/" + fileName);
		return resultString;
	}
